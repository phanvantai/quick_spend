...
/// Dialog for adding or editing a recurring expense template
class RecurringTemplateDialog extends StatefulWidget {
  final RecurringExpenseTemplate? template; // null for add, non-null for edit
  final String userId;

  const RecurringTemplateDialog({
    super.key,
    this.template,
  ...
  @override
  State<RecurringTemplateDialog> createState() =>
      _RecurringTemplateDialogState();
}

class _RecurringTemplateDialogState extends State<RecurringTemplateDialog> {
  ...
  Future<void> _saveTemplate() async {
    ...
    try {
      ...
      debugPrint('❌ [RecurringTemplateDialog] Error saving template: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
