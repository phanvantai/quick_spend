...
struct HomeStringsTests {
    ...
    // MARK: - String Methods Return Non-Empty for English

    @Test("overviewTitle returns non-empty for English")
    func testOverviewTitleNonEmpty() {
        let result = HomeStrings.overviewTitle("en")
        #expect(!result.isEmpty)
    }

    @Test("balance returns non-empty for English")
    func testBalanceNonEmpty() {
        let result = HomeStrings.balance("en")
        #expect(!result.isEmpty)
    }

    @Test("expense returns non-empty for English")
    func testExpenseNonEmpty() {
        let result = HomeStrings.expense("en")
        #expect(!result.isEmpty)
    }

    @Test("income returns non-empty for English")
    func testIncomeNonEmpty() {
        let result = HomeStrings.income("en")
        #expect(!result.isEmpty)
    }

    @Test("reportTitle returns non-empty for English")
    func testReportTitleNonEmpty() {
        let result = HomeStrings.reportTitle("en")
        #expect(!result.isEmpty)
    }

    @Test("spent returns non-empty for English")
    func testSpentNonEmpty() {
        let result = HomeStrings.spent("en")
        #expect(!result.isEmpty)
    }

    @Test("earned returns non-empty for English")
    func testEarnedNonEmpty() {
        let result = HomeStrings.earned("en")
        #expect(!result.isEmpty)
    }

    @Test("viewDetailedReport returns non-empty for English")
    func testViewDetailedReportNonEmpty() {
        let result = HomeStrings.viewDetailedReport("en")
        #expect(!result.isEmpty)
    }

    @Test("trendsTitle returns non-empty for English")
    func testTrendsTitleNonEmpty() {
        let result = HomeStrings.trendsTitle("en")
        #expect(!result.isEmpty)
    }
}
