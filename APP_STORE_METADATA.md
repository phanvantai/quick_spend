...
```bash
TRACK EXPENSES & INCOME WITH YOUR VOICE

Just speak naturally and let AI organize your finances automatically. No typing required.
...
```bash
GHI CHI TIÊU & THU NHẬP BẰNG GIỌNG NÓI

Chỉ cần nói tự nhiên và để AI sắp xếp tài chính tự động. Không cần gõ chữ.
